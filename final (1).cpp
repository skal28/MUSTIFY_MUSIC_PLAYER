...
//here n_node and root are declared as global pointers
//CONCEPT OF BST IS BEING USED FOR STORING THE VALUES
...
node* insert(node* root,int key)
{
    ...
    {
        //here new data node is contained in n_node
...
{
    //loading();
    cout<<"\t\t\t\t~~~~THIS IS THE ARTIST SECTION~~~"<<endl<<endl;
    cout<<"\t\t $$$$$$$$$SELECT YOUR ARTIST AND SONG $$$$$$$$$$"<<endl<<endl;
...
// VECTOR
   // transform(a.begin(),a.end(),a.begin(),::tolower);
    ...
    {
        cout<<"\nSELECT YOUR DESIRED ARTIST (1 at a time) FROM THE FAMOUS ARTISTS!!"<<endl<<endl;
...
void musifySignUps()
{
    ...
    cout<<"\nEnter your name :\t";
    fflush(stdin);
//name was G.V. of String data type
    getline(cin,name);
//mob was G.V. of long long data type
    cout<<"\nEnter your mobile number :\t";
    cin>>mob;

    cout<<"\nEnter any key to generate your UNIQUE ID for logging in."<<endl;
    cin>>a;
    cout<<"LOADING";
    for(int j=0; j<21; j++)
    {
    ...
    cout<<"Your UNIQUE password is same as your UNIQUE ID."<<endl;
    cout<<"Creating account!!!!";
    for(int j=0; j<21; j++)
    {
        //load(9999999);
...
void signup()
{
   // loading();
    cout<<"\t\t\t\t$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$"<<endl;
    cout<<"\t\t\t\t\WELCOME TO THIS PAGE FOR SIGNNING UP"<<endl;
    cout<<"\t\t\t\t$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$"<<endl<<endl;
    cout<<"\t\t\t\t~~~~~ SIGNUP NOW ~~~~~~"<<endl<<endl;
    cout<<"Get your desired song on our Music app player"<<endl<<endl;
...
void login()
{
    cout<<"Enter your unique ID for login :\t\t";
//mid is global variable of string data type and
//b is of long long data type
    cin>>mid;
    b=mid.size();
//necessary condition for a music id to be valid hence login success

    if(b<=3)
    {
        cout<<"\n\t'"<<mid<<"it is not the correct credential"<<endl;
       // cout<<"\tMusify Id always ends with '000'"<<endl;
        cout<<"\tYOUR ID IS INCCORECT LOGIN AGAIN...."<<endl<<endl;
//recursive call for login function is made again after fail to login
        login();
    }
    else
    {
// sub was global variable of String data type
//substr is used to take a specific part from any word
        sub=mid.substr(b-3,b);
        if(sub=="000")
        {
            cout<<"ENTER THE UNIQUE PASSWORD GIVEN DURING THE TIME OF SIGNUP:\t";
//fflush(stdin) is to clear the output buffer
            fflush(stdin);
//mpass G.V. of String
/getLine(cin,mpass) is basically used to check whether the entered password have space OR NOT/
            getline(cin,mpass);
            if(mid==mpass)
            {
                //loading();
           cout<<"\t\t\t\t$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$"<<endl;
           cout<<"Successfully LOGED IN"<<endl<<endl;;
           cout<<"\t\t\t\t$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$"<<endl;
...
//calloc
    ...
    cout<<"\n";
    // this function is used to clear screen only
system("cls");
//BST TREE CALL IS MADE
    root=insert(root,6);
    root=insert(root,1);
    root=insert(root,2);
    root=insert(root,11);
...
//FIRST DISPLAY TO SCREEEN
    ...
    cout<<"\t\t\t\t\tWELCOME TO MUSIFY     "<<endl;
    cout<<"\t\t\t\t**************"<<endl<<endl<<endl;
    cout<<"LLISTEN LATEST BOLLYWOOD HITS HERE."<<endl<<endl;
    ...
    do
    {
        ...
        case 'a':
            lists();
// START IS DECLARED TO NODE* start=NULL
            start=addNode(start);
            break;
        case 'b':
        ...
        case 'd':
            ...
            break;
        case 'e':
// TO SHUFLE SONGS WE HAVE USED PREORDER POSTORDER AND INORDER
            preorder(root);
            break;
        case 'f':
            postorder(root);
...
//d maybe declared for int type earlier maybeee
            cin>>d;
            q.push(d);
            root=search(root,d);
            break;
